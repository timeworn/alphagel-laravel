...
class PublishModel extends Model
{
        ...
        if ($isValid['result'] === true) {
            ...
            DB::transaction(function () {
                $id = DB::table('products')->insertGetId([
                    ...
                    'info01_image' => $this->post['info01_image_name'],
                ...
                foreach ($this->post['translation_order'] as $translate) {
                    DB::table('products_translations')->insert([
                        ...
                        'info01' => htmlspecialchars(trim($this->post['info01'][$i])),
                        'info02' => htmlspecialchars(trim($this->post['info02'][$i])),
                        'info03' => htmlspecialchars(trim($this->post['info03'][$i])),
    ...
    private function filesUpload()
    {
         ...
         * Upload type image
         * */
        $this->post['info01_image_name'] = '';
        if (isset($this->post['info01_image'])) {
            $this->post['info01_image_name'] = Storage::putFile('public/images', $this->post['info01_image']);
            $this->post['info01_image_name'] = str_replace('public/', '', $this->post['info01_image_name']);
        }
        if (isset($this->post['info01_old_image']) && !isset($this->post['info01_image'])) {
            $this->post['info01_image_name'] = $this->post['info01_old_image'];
        }
        /*
