                ...
                <div class="card-body"> 
                    ...
                    <div class="locale-container locale-container-{{$locale}}" @if ($currentLocale == $locale) style="display:block;" @endif>
                        <div class="md-form">
                            ...
                            <input type="text" name="product_id" value="{{isset($product['product']->product_id) ? $product['product']->product_id : ''}}" id="publishForm-product-id-{{$locale}}" class="form-control">
                            <label for="publishForm-name-{{$locale}}">{{__('admin_pages.product_id')}}({{$locale}})</label>
                        </div>
                        <div class="md-form">
                            <i class="fa fa-font prefix grey-text"></i>
                        ...
                        <div class="md-form">
                            <i class="fa fa-font prefix grey-text"></i>
                            <input type="text" name="info01[]" value="{{ $lKey !== false ? $product['translations'][$lKey]->info01 : '' }}" id="publishForm-info01-{{$locale}}" class="form-control">
                            <label for="publishForm-info01-{{$locale}}">{{__('admin_pages.product_info01')}}({{$locale}})</label>
                        </div>
                        <div class="md-form">
                            <i class="fa fa-font prefix grey-text"></i>
                            <input type="text" name="info02[]" value="{{ $lKey !== false ? $product['translations'][$lKey]->info02 : '' }}" id="publishForm-info02-{{$locale}}" class="form-control">
                            <label for="publishForm-info02-{{$locale}}">{{__('admin_pages.product_info02')}}({{$locale}})</label>
                        </div>
                        <div class="md-form">
                            <i class="fa fa-font prefix grey-text"></i>
                            <input type="text" name="info03[]" value="{{ $lKey !== false ? $product['translations'][$lKey]->info03 : '' }}" id="publishForm-info03-{{$locale}}" class="form-control">
                            <label for="publishForm-info03-{{$locale}}">{{__('admin_pages.product_info03')}}({{$locale}})</label>
                        </div>
                        <div class="md-form">
                    ...
                    <div class="md-form clone-file-upload">
                        ...
                        <div class="element-label-text">
                            <div class="upload-wrap boundle-image">
                    ...
                    @php
                        if(isset($product['product']->info01_image)) {
                    @endphp
                    <input type="hidden" value="{{$product['product']->info01_image}}" name="info01_old_image">
                    <div class="md-form">
                        <img src="{{asset('storage/'.$product['product']->info01_image)}}" alt="{{__('admin_pages.no_choosed_image')}}" style="max-height: 300px;" class="img-thumbnail">
                    </div>
                    @php
                        }
                    @endphp
                    <div class="md-form clone-file-upload">
                        <label class="alone">{{__('admin_pages.type_image')}}</label>
                        <div class="element-label-text">
                            <div class="upload-wrap info01-upload">
                                <button type="button" class="btn btn-secondary">{{isset($product['product']->info01_image) ? __('admin_pages.choose_new_cover_img') : __('admin_pages.choose_cover_img')}}</button>
                                <input type="file" name="info01_image" id="info01-upload" class="upload-btn">
                                <div class="file-name"></div>
                            </div>
                        </div>
                    </div>
...
$('.upload-wrap.boundle-image .file-name').show().append(this.value);
};
document.getElementById('info01-upload').onchange = function () {
    $('.upload-wrap.info01-upload .file-name').show().append(this.value);
};
