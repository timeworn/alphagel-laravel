...
@section('content')
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <label class="active pb-1">{{__('admin_pages.choose_country_code')}}</label>
                                <select class="selectpicker" name="country_code" data-style="btn-secondary">
                                    @foreach ($countries as $item)
                                        <option value="{{$item->code}}" {{isset($itemInfo->country_code)
                                                                                && $itemInfo->country_code == $item->code ?
                                                                                 'selected' : ''}}>
                        ...
                        <div class="md-form">
                            <textarea id="seo_content" name="content">{{isset($itemInfo->content) ? $itemInfo->content : ''}}</textarea>
                        </div>
                        <hr>
    ...
    <script src="https://cdn.tiny.cloud/1/gl551frtpxin1rzglbmofijl15ukgfdml0i0s9na6a2yhsql/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    <script>
