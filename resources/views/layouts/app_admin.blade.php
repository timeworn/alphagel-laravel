                    ...
                    <div class="row">
                        <div class="col-sm-3 col-md-3 col-lg-2 left-side">
                            ...
                            <ul class="nav">
                                ...
                                <li>
                                    <a href="{{ lang_url('admin/setting') }}" class="btn waves-effect waves-light">
                                        <i class="material-icons">settings</i>
                                        <p>{{__('admin_pages.setting')}}</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ lang_url('admin/seo') }}" class="btn waves-effect waves-light">
                                        <i class="material-icons">pages</i>
                                        <p>{{__('admin_pages.seo_page')}}</p>
                                    </a>
                                </li>
                                @if(Config::get('constants.front_end_admin') =='no')
                                    <li>
                                ...
                                <li>
                                    <a href="{{ lang_url('admin/traffic') }}" class="btn waves-effect waves-light">
                                        <i class="material-icons">traffic</i>
                                        <p>{{__('admin_pages.traffic')}}</p>
                                    </a>
                                </li>
                                <li>
